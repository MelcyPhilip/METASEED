...
If you want to test the METASEED method, you can download this tar-archive, untar it, and read its README.html on how to run the procedure on the small sample data set provided: (https://zenodo.org/records/20642803)
